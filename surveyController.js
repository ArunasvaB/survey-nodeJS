...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var whatFonts = readData("whatFonts");
        var colours = readData("colours");
        var ft = readData("ft");
        var design = readData("design");
        var slider = readData("slider");
        var color = readData("color");

        res.render('showResults', {results: [whatFonts,colours,ft,design,slider,color]});
        console.log([whatFonts,colours,ft,design,slider,color]);
        console.log([whatFonts,colours,ft,design,slider,color]);
    });
